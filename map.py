...
#Create a lambda funtion to check if the given string is palindrome or not
...
#Wap to extract only integers from thr list
...
#Extract all the string values from the tuple only if it is starting with uppercasse
...
#Program to extract all the collection values present
